document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateUI(lang){
    ...
    const freeLink=document.getElementById("freeGrokLink");
    if(freeLink) freeLink.innerHTML=`<a href="https://console.groq.com/keys" target="_blank">${texts.freeGrokLink}</a>`;
  }
  updateUI("ko");
